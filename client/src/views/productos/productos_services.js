...
export default {
	getAll (){
		return new Promise((resolve, reject) => {
			axios.get(apiDomain + '/products', { headers: {
				'Content-Type': 'application/json',
    			'token': localStorage.getItem('access_token')
			}})
				.then((response) => {
	...
	getBy ( idCliente ) {
		return new Promise((resolve, reject) => {
			axios.get(apiDomain + '/products' + idCliente + '/', { headers: {
				'Content-Type': 'application/json',
    			'token': localStorage.getItem('access_token')
			}})
				.then((response) => {					
	...
	save ( dataCliente ) {
		return new Promise((resolve, reject) => {
			axios.post(apiDomain + '/products/create', dataCliente, { headers: {
				'Content-Type': 'application/json',
			    'token': localStorage.getItem('access_token')
			}})
				.then((response) => {
	...
	update ( idCliente, dataCliente ) {
		return new Promise((resolve, reject) => {
			axios.put(apiDomain + '/products/u/' + idCliente , dataCliente, { headers: {
				'Content-Type': 'application/json',
			    'token': localStorage.getItem('access_token')
			}})
				.then((response) => {
	...
	delete ( idCliente ) {
		return new Promise((resolve, reject) => {
			axios.delete(apiDomain + '/products/d/' + idCliente, { headers: {
				'Content-Type': 'application/json',
			    'token': localStorage.getItem('access_token')
			}})
				.then((response) => {
